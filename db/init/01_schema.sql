...
create table teachers (
  id uuid primary key default gen_random_uuid(),
  -- رقم ظاهر للعرض؛ المفتاح الأساسي يبقى uuid (١١ مفتاحاً أجنبياً يشير إليه)
  code int generated by default as identity (start with 101),
...
create table students (
  id uuid primary key default gen_random_uuid(),
  -- رقم ظاهر للعرض وللمسارات؛ المفتاح الأساسي يبقى uuid
  code int generated by default as identity (start with 1001),
  user_id uuid not null references users(id) on delete cascade,
